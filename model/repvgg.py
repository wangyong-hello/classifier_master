...
weights_dict = {
'RepVGG-A0': 'https://github.com/z1069614715/pretrained-weights/releases/download/repvgg_v1.0/RepVGG-A0-train.pth',
'RepVGG-A1': 'https://github.com/z1069614715/pretrained-weights/releases/download/repvgg_v1.0/RepVGG-A1-train.pth',
'RepVGG-A2': 'https://github.com/z1069614715/pretrained-weights/releases/download/repvgg_v1.0/RepVGG-A2-train.pth',
'RepVGG-B0': 'https://github.com/z1069614715/pretrained-weights/releases/download/repvgg_v1.0/RepVGG-B0-train.pth',
'RepVGG-B1': 'https://github.com/z1069614715/pretrained-weights/releases/download/repvgg_v1.0/RepVGG-B1-train.pth',
'RepVGG-B1g2': 'https://github.com/z1069614715/pretrained-weights/releases/download/repvgg_v1.0/RepVGG-B1g2-train.pth',
'RepVGG-B1g4': 'https://github.com/z1069614715/pretrained-weights/releases/download/repvgg_v1.0/RepVGG-B1g4-train.pth',
'RepVGG-B2': 'https://github.com/z1069614715/pretrained-weights/releases/download/repvgg_v1.0/RepVGG-B2-train.pth',
'RepVGG-B2g4': 'https://github.com/z1069614715/pretrained-weights/releases/download/repvgg_v1.0/RepVGG-B2g4-train.pth',
'RepVGG-B3': 'https://github.com/z1069614715/pretrained-weights/releases/download/repvgg_v1.0/RepVGG-B3-200epochs-train.pth',
'RepVGG-B3g4': 'https://github.com/z1069614715/pretrained-weights/releases/download/repvgg_v1.0/RepVGG-B3g4-200epochs-train.pth',
'RepVGG-D2se': 'https://github.com/z1069614715/pretrained-weights/releases/download/repvgg_v1.0/RepVGG-D2se-200epochs-train.pth',
}

__all__ = ['get_RepVGG_func_by_name']
...
def get_RepVGG_func_by_name(name, pretrained=False):
    model = func_dict[name]()
    if pretrained:
...
if __name__ == '__main__':
    ...
    # model = get_RepVGG_func_by_name('RepVGG-A0', pretrained=False)
    # model.eval()
    # out = model(inputs)
