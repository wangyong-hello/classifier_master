...
from utils import load_weights_from_state_dict, fuse_conv_bn
...
weights_dict = {
    'repghostnet_0_5x': 'https://github.com/z1069614715/pretrained-weights/releases/download/repghost_v1.0/repghostnet_0_5x_43M_66.95.pth.tar',
    'repghostnet_0_58x': 'https://github.com/z1069614715/pretrained-weights/releases/download/repghost_v1.0/repghostnet_0_58x_60M_68.94.pth.tar',
    'repghostnet_0_8x': 'https://github.com/z1069614715/pretrained-weights/releases/download/repghost_v1.0/repghostnet_0_8x_96M_72.24.pth.tar',
    'repghostnet_1_0x': 'https://github.com/z1069614715/pretrained-weights/releases/download/repghost_v1.0/repghostnet_1_0x_142M_74.22.pth.tar',
    'repghostnet_1_11x': 'https://github.com/z1069614715/pretrained-weights/releases/download/repghost_v1.0/repghostnet_1_11x_170M_75.07.pth.tar',
    'repghostnet_1_3x': 'https://github.com/z1069614715/pretrained-weights/releases/download/repghost_v1.0/repghostnet_1_3x_231M_76.37.pth.tar',
    'repghostnet_1_5x': 'https://github.com/z1069614715/pretrained-weights/releases/download/repghost_v1.0/repghostnet_1_5x_301M_77.45.pth.tar',
    'repghostnet_2_0x': 'https://github.com/z1069614715/pretrained-weights/releases/download/repghost_v1.0/repghostnet_2_0x_516M_78.81.pth.tar',
}
...
class RepGhostBottleneck(nn.Module):
    ...
    def switch_to_deploy(self):
        if len(self.shortcut) != 0:
            self.shortcut = nn.Sequential(
                fuse_conv_bn(self.shortcut[0], self.shortcut[1]),
                fuse_conv_bn(self.shortcut[2], self.shortcut[3]),
            )
...
class RepGhostNet(nn.Module):
    def __init__(
        ...
        self.conv_stem = nn.Conv2d(3, output_channel, 3, 2, 1, bias=False)   #tag：input_channel ==1
...
def repghostnet(enable_se=True, pretrained=False, name=None, **kwargs):
    """
...
def repghostnet_0_5x(**kwargs):
    return repghostnet(width=0.5, name='repghostnet_0_5x', **kwargs)


def repghostnet_repid_0_5x(**kwargs):
    return repghostnet(width=0.5, name='repghostnet_0_5x', reparam_bn=False, reparam_identity=True, **kwargs)


def repghostnet_norep_0_5x(**kwargs):
    return repghostnet(width=0.5, name='repghostnet_0_5x', reparam=False, **kwargs)


def repghostnet_wo_0_5x(**kwargs):
    return repghostnet(width=0.5, name='repghostnet_0_5x', shortcut=False, **kwargs)


def repghostnet_0_58x(**kwargs):
    return repghostnet(width=0.58, name='repghostnet_0_58x', **kwargs)


def repghostnet_0_8x(**kwargs):
    return repghostnet(width=0.8, name='repghostnet_0_8x', **kwargs)


def repghostnet_1_0x(**kwargs):
    return repghostnet(width=1.0, name='repghostnet_1_0x', **kwargs)


def repghostnet_1_11x(**kwargs):
    return repghostnet(width=1.11, name='repghostnet_1_11x', **kwargs)


def repghostnet_1_3x(**kwargs):
    return repghostnet(width=1.3, name='repghostnet_1_3x', **kwargs)


def repghostnet_1_5x(**kwargs):
    return repghostnet(width=1.5, name='repghostnet_1_5x', **kwargs)


def repghostnet_2_0x(**kwargs):
    return repghostnet(width=2.0, name='repghostnet_2_0x', **kwargs)

if __name__ == '__main__':
    # inputs = torch.rand((1, 1, 224, 224))
    model = repghostnet_1_0x(pretrained=True)
    # model.eval()
    # out = model(inputs)
